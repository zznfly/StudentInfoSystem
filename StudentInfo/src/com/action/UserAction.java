...
public class UserAction extends ActionSupport implements ServletRequestAware {
	...
	public String login() {
		...
		/*
		 * if(StringUtil.isEmpty(imageCode)){ error="验证码为空！"; return ERROR; }
		 * if(!imageCode.equals(session.getAttribute("sRand"))){ error="验证码错误！";
		 * return ERROR; }
		 */
		Connection con = null;
	...
	public String preSaves() {
		navCode = NavUtil2.getNavgation("系统管理", "修改密码");
